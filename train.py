...
def parse_ags1():
    ...
    parser.add_argument("--epochs", type=int, default=30, help='20')
    parser.add_argument('--lr', type=float, default=3e-4, help='学习率 (default: 0.01,3e-4)')
    parser.add_argument('--train_data', default="./data_preparation/Synthetic/VAL3", help='数据集的path')
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch_idx, (train_X, train_mask, train_nearend_mic_magnitude, train_nearend_magnitude) in enumerate(
            ...
            train_loss = criterion(train_nearend_magnitude, pred_near_spectrum)
