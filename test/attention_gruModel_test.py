...
torchaudio.save("./predict/nearend_speech_fileid_gru_" + index + ".wav", src=per_nearend.cpu().detach(), sample_rate=fs)
...
recover_wav, _ = librosa.load("./predict/nearend_speech_fileid_gru_" + index + ".wav", sr=16000)
