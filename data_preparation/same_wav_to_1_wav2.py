...
nearend_speech = 22
new_dir = 'E:\\TrainWav\\TRAIN2\\farend_speech2\\'  # wav语音文件所在文件夹
output_dir = 'E:\\TrainWav\\TRAIN2_2\\farend_speech2\\'  # wav输出语音文件所在文件夹
list_voice_dir = os.listdir(new_dir)
list_voice_dir.sort(key=lambda x: int(x[farend_speech:][:-4]))  # 先取12位之后，再倒着数第四位'.'为分界线，按照‘.'左边的数字从小到大
