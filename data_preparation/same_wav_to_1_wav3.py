...
nearend_speech = 22
new_dir = 'E:\\TrainWav\\TRAIN2\\nearend_mic_signal2\\'  # wav语音文件所在文件夹
output_dir = 'E:\\TrainWav\\TRAIN2_2\\nearend_mic_signal2\\'  # wav输出语音文件所在文件夹
list_voice_dir = os.listdir(new_dir)
list_voice_dir.sort(key=lambda x: int(x[nearend_mic_signal:][:-4]))  # 先取12位之后，再倒着数第四位'.'为分界线，按照‘.'左边的数字从小到大
