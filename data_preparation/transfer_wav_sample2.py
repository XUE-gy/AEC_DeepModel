...
#
#     inputPath = "E:\\TrainWav\\TRAIN2_2\\echo_signal\\"
#     outputPath = "E:\\TrainWav\\TRAIN2_2\\echo_signal\\"
#
#     name = inputPath + "echo_fileid_" + str(i) + ".wav"
#     outputName = outputPath + "echo_fileid_" + str(i) + ".wav"
#     # name = ""
...
outputName = outputPath + "playlist_44100.wav"
# name = ""
src_sig,sr = sf.read(name)  #name是要 输入的wav 返回 src_sig:音频数据  sr:原采样频率
# print(src_sig)
print(sr)
